...
classes.py - содержит классы для работы с API и базой данных Postgres
utils.py - содержит вспомогательные функции
main.py - основной фыйл программы, в котором осуществляется взаимодействие с пользователем

data/selected_employers_id.json - json-файл, в котором хранятся id компаний-работодателей с сайта НН, отобранные для анализа данных
